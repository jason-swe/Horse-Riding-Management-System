...
function adaptViolation(value) {
  ...
  return {
    ...
    penaltyType: value.penalty?.type || "pending_review",
...
function adaptResult(value) {
  ...
  return {
    ...
    rawFinishTime: value.raw_finish_time ?? value.finish_time,
    rawScore: value.raw_score ?? value.score,
    finalPosition: value.final_position ?? value.position,
    finalFinishTime: value.final_finish_time ?? value.finish_time,
