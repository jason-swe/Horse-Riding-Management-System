...
function ViolationManagement() {
  ...
  const decide = async (action) => {
    ...
    try {
      ...
      await reload();
      addMsg(action === "confirm" ? "Violation confirmed and policy penalty assigned." : "Violation dismissed with an audit decision.");
      setSelectedViolation(null);
    } catch (apiError) {
